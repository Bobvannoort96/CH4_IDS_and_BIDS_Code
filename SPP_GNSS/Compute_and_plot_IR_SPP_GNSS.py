...
close_plots = False  # Set to True if you want to close plots after every 'combination'
...
combinations = [["IDS", "A", "P5"], ["R_IDS", "A", "P5"], ["classical DIA", "B", "P5"]]
type_T_, type_DS_ = ",", ","
...
for comb in combinations:
    ...
    if scenario_nr is None:
        ...
        main_dir = r"C:\Users\bgvannoort\Documents\IDS\Results\TestingProbabilities\SPP_GNSS\scenario_type_{}".format(
            scenario_nr
        )
...
fig_comb, ax_comb = compare_test_procedures()
...
for hypt in range(1, m + 1):
    plot_IR_vs_bias_under_Hi(hypt_i=hypt)
